...
const PropertyAbout: React.FC<PropertyAboutProps> = ({ 
  description = `Discover the epitome of urban luxury at Skyline Towers. This meticulously designed 4T residence offers a seamless blend of contemporary architecture and premium living. The property features an expansive living area with floor-to-ceiling windows, premium oak flooring, and state-of-the-art smart home integration.
