...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative bg-[#f0eded] pt-20 pb-32 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.p variants={itemVariants} className="font-manrope font-light text-xl leading-7 text-[#4b5563] mb-12 max-w-[676px]">
                Every listing, every transaction, every record—permanently verified and completely transparent.
