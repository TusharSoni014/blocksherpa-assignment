...
const FilterSidebar: React.FC<FilterSidebarProps> = ({ onFilterChange }) => {
  ...
  useEffect(() => {
    ...
    if (priceRange[0] > 0 || priceRange[1] < 2000000) filters.priceRange = priceRange;
    ...
    <div className="w-[359px] bg-white border-r border-[#E6E0DA] h-screen sticky top-20 overflow-y-auto pb-24">
      <div className="p-6">
        ...
        <div className="mb-8 border-b border-[#F5F1E8] pb-8">
          ...
          {/* Min slider */}
          <label className="font-manrope text-xs text-[#9CA3AF] mb-1 block">
            Min
          </label>
          ...
          <div className="flex justify-between px-1">
            ...
            <span className="font-manrope text-xs text-[#9CA3AF]">$2M+</span>
          </div>
        </div>
