...
const FAQSection: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      answer: "We currently cover major metropolitan areas including Ahmedabad, Rio de Janeiro. We're expanding to more cities across Brazil and will update our coverage area regularly."
    },
    {
      id: 3,
      question: "Can I list my property exclusively with REChain?",
