...
import { Sparkles, MapPin, DollarSign, Home, Building2, Search, Loader2, KeyRound, CheckCircle2, AlertTriangle } from 'lucide-react';
...
const ALL_CITIES = [
  ...
  'São Gonçalo', 'Maceió', 'Duque de Caxias', 'Nova Iguaçu', 'São Bernardo do Campo',
  'Teresina', 'Natal', 'Campo Grande', 'São José dos Campos', 'Santo André',
  'Ribeirão Preto', 'Jaboatão dos Guararapes', 'Osasco', 'Sorocaba', 'Uberlândia',
  'Contagem', 'Aracaju', 'Feira de Santana', 'Cuiabá', 'Joinville',
  'Aparecida de Goiânia', 'Londrina', 'Ananindeua', 'Porto Velho', 'Juiz de Fora',
  'Niterói', 'São José dos Pinhais', 'Maringá', 'Diadema', 'Mauá',
  'Betim', 'Campina Grande', 'Caxias do Sul', 'Olinda', 'Caruaru',
  'Florianópolis', 'São Vicente', 'Vitória', 'Petrolina', 'Santos',
  'Blumenau', 'Petrópolis', 'Canoas', 'Moji das Cruzes', 'Piracicaba',
  'Bauru', 'Jundiaí', 'Nova Friburgo', 'Montes Claros', 'Ribeirão das Neves',
  'Anápolis', 'Paulista', 'Cabo de Santo Agostinho', 'Uberaba', 'Governador Valadares',
  'Taubaté', 'Limeira', 'São José do Rio Preto', 'Franca', 'Suzano',
  'Taboão da Serra', 'Sumaré', 'Praia Grande', 'Várzea Grande', 'Barueri',
  'Indaiatuba', 'Cotia', 'Santa Maria', 'Gravataí', 'Juazeiro do Norte',
  'Vitória da Conquista', 'Rio Branco', 'Boa Vista', 'Macapá', 'Palmas'
];
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
              ...
              <div>
                ...
                <div className="relative bg-white border border-[#E6E0DA] rounded-xl p-4 flex items-center gap-3 focus-within:ring-2 focus-within:ring-[#D4755B]/30 focus-within:border-[#D4755B] transition-all shadow-sm">
                  <DollarSign className="w-5 h-5 text-[#D4755B] shrink-0" />
                  <input
                    type="number"
                    value={maxBudget}
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                {(['Any', '1T', '2T', '3T', '4T+'] as const).map((option) => (
                  <button
                    key={option}
                    type="button"
                    onClick={() => setT(option)}
            ...
            {loading && (
              <div className="mt-5 bg-[#FAF8F4] border border-[#E6E0DA] rounded-xl p-5">
                ...
                <p className="font-manrope text-xs text-[#9CA3AF] text-center mt-5 leading-relaxed">
                  {T !== 'Any' ? `${T} ` : ''}{propertyType.toLowerCase()}s
